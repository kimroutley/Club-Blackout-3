...
class GameCommentator {
  static String generateCommentary(LiveGameStats stats, int dayCount) {
    ...
    // Analyze Game State
    bool dealersDominaing = stats.dealerPercentage >= 0.6;
    bool partyDominating = stats.partyPercentage >= 0.6;
    bool nearlyExtinct = stats.aliveCount <= 3;
    bool bloodbath = stats.aliveCount < (stats.totalPlayers / 2);
    bool crowded = stats.aliveCount > (stats.totalPlayers * 0.8);
